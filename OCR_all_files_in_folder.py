...
target_directory = r"C:\Users\dee.HFMLEGAL\Desktop\ocr"
...
def main():
    all_files_in_folder = fetch_all_files(target_directory)
    for file in all_files_in_folder:
        ...
        if file_extension == ".pdf" or file_extension == ".PDF":
            proccess_PDFs(file, root_directory, file_w_ext, file_name)
